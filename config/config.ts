          ...
          routes: [
            {
              ...
              component: './TiepNhanHoSoNhapHoc/ChuaKhoaHoSoNhapHoc',
            },
            {
              name: 'DaKhoaHoSoNhapHoc',
              path: './dakhoahosonhaphoc',
              access: 'routeFilter',
              maChucNang: 'ho-so-nhap-hoc-da-xac-nhan:read-all',
              component: './TiepNhanHoSoNhapHoc/DaKhoaHoSoNhapHoc',
            },
            {
              name: 'DaTiepNhanHoSoNhapHoc',
              path: './datiepnhanhosonhaphoc',
              access: 'routeFilter',
              maChucNang: 'ho-so-nhap-hoc-da-hoan-thien:read-all',
              component: './TiepNhanHoSoNhapHoc/DaTiepNhanHoSoNhapHoc',
            },
            {
              name: 'YeuCauChinhSuaHoSoNhapHoc',
              path: './yeucauchinhsuahosonhaphoc',
              access: 'routeFilter',
              maChucNang: 'ho-so-nhap-hoc-du-dieu-kien:read-all',
              component: './TiepNhanHoSoNhapHoc/YeuCauChinhSuaHoSoNhapHoc',
            },
          ],
        },
      ],
