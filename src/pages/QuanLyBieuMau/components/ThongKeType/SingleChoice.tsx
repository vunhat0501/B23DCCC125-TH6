    ...
    <div>
      <Chart height={400} data={dv} scale={cols} padding={0} forceFit>
        ...
        <Guide>
          <Html
            position={['50%', '50%']}
            html={`<div style="color:#8c8c8c;font-size:1.16em;text-align: center;width: 10em;">Số lượt trả lời<br><span style="color:#262626;font-size:2.5em">${props.tong}</span>người</div>`}
            alignX="middle"
            alignY="middle"
          />
        </Guide>
