			...
			<div ref={this.getViewDom}>
              ...
              >
                <Input placeholder="Họ và tên" />
							...
							<Row gutter={[20, 0]}>
								<Col xs={24} lg={12}>
									<Form.Item
										...
										initialValue={currentUser?.ngay_sinh ? moment(currentUser?.ngay_sinh) : undefined}
									>
										<DatePicker
											style={{ width: '100%' }}
											format='DD/MM/YYYY'
							...
							<Form.Item initialValue={currentUser?.email || ''} name='email' label='Email' rules={[...rules.email]}>
