		...
		return (
			<div className={styles.detail}>
				...
				<p>
					...
					/>
					{currentUser?.ngay_sinh ? moment(currentUser?.ngay_sinh).format('DD/MM/YYYY') : 'Chưa cập nhật'}
				</p>
				<p>
					<ManOutlined
						style={{
							...
							{!dataLoading && (
								<div>
									<div className={styles.avatarHolder}>
										<img alt='' src={currentUser?.avatar_path || '/logo.png'} />
...
export default connect(
	({ loading, accountAndcenter }: { loading: { effects: Record<string, boolean> }; accountAndcenter: ModalState }) => ({
