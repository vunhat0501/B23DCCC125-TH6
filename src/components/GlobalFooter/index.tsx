    ...
    <Row justify="center" className={styles.row}>
      <Col xs={24} lg={17}>
        ...
        <Row style={{ marginTop: 30 }}>
          <Col xs={24} lg={11}>
            <Row>
              <div className={styles.text1} style={{color: '#202124'}}>Trụ sở chính:</div>
            </Row>
            <Row>
              <div className={styles.text1} style={{color: '#202124'}}>122 Hoàng Quốc Việt, Q.Cầu Giấy, Hà Nội.</div>
            </Row>
          </Col>
          <Col xs={24} lg={12}>
            <Row>
              <div className={styles.text1} style={{color: '#202124'}}>Học viện cơ sở tại TP. Hồ Chí Minh:</div>
            </Row>
            <Row>
        ...
        <Row style={{ marginTop: 20 }}>
          <Col xs={24} lg={11}>
            <Row>
              <div className={styles.text1} style={{color: '#202124'}}>Cơ sở đào tạo tại Hà Nội:</div>
            </Row>
            <Row>
              <div className={styles.text1} style={{color: '#202124'}}>Km10, Đường Nguyễn Trãi, Q.Hà Đông, Hà Nội</div>
            </Row>
          </Col>
          <Col xs={24} lg={12}>
            <Row>
              <div className={styles.text1} style={{color: '#202124'}}>Cơ sở đào tạo tại TP Hồ Chí Minh:</div>
            </Row>
            <Row>
              <div className={styles.text1} style={{color: '#202124'}}>Đường Man Thiện, P. Hiệp Phú, Q.9 TP Hồ Chí Minh</div>
            </Row>
          </Col>
        </Row>
      </Col>
